...
func TestLatestVersions(t *testing.T) {
	testCases := []struct {
		...
		{
			versionSlice:   []string{"1.8.11", "1.9.6", "1.10.1", "1.9.5", "1.8.10", "1.10.1-alpha.2", "1.7.14", "1.8.9", "1.9.5"},
			expectedResult: []string{"1.10.1", "1.9.6"},
			minVersion:     semver.New("1.8.12"),
		},
		{
			versionSlice:   []string{"1.10.1-rc.1", "1.10.1-beta.3", "1.8.10", "1.10.1-rc.2", "1.7.14", "1.8.9", "1.9.5"},
			expectedResult: []string{"1.10.1-rc.2"},
			minVersion:     semver.New("1.10.1-beta.2"),
		},
		{
